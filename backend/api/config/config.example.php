...
define('DB_PASS', '');                 // Leave empty or put placeholder
define('DB_NAME', 'online_quiz_system'); // Your database name
...
define('APP_URL', 'http://localhost');       // Update with your actual URL if needed
